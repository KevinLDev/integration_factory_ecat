...
O estado operacional evoluiu desde então. Atualmente, a jornada de ERP parceiro possui os Passos 01 a 09 disponiveis; o Passo 06 termina em `PRONTO_PARA_EXECUCAO_HML`, o Passo 07 executa e valida tecnicamente em HML, o Passo 08 homologa funcionalmente a integracao em modelo manual assistido por IA e o Passo 09 consolida/publica a integracao homologada sem producao. `INTEGRACAO_HOMOLOGADA: SIM` so pode ser registrada apos auditoria independente aprovada do Passo 08, e `INTEGRACAO_PUBLICADA: SIM` so pode ser registrada apos auditoria independente aprovada do Passo 09. A jornada de ERP cliente continua nao liberada. Para o estado vigente, consulte `AGENTS.md` e `comece-aqui/integrar-erp/erp-parceiro/00-COMECE-AQUI.md`.
...
Posteriormente, os Passos 01 a 09 de ERP parceiro foram publicados. Essa evolucao nao muda o principio historico: uma etapa so se torna operacional quando seu comando tecnico e seu documento humano correspondente estao oficialmente disponiveis.
