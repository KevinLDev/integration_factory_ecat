...
A jornada de ERP cliente possui os Passos 01, 02, 03, 04 e 05 liberados para resolucao de contexto/elegibilidade, analise da realidade comercial e tecnica, projeto da instalacao sem materializacao, materializacao em HML do que foi projetado e validacao tecnica/funcional dessa materializacao, preparando a decisao de producao. A primeira execucao real de cada combinacao (Passos 04 e 05) exige auditoria independente PROFUNDA, e nenhuma das duas execucoes produtoras se autoaprova. O Passo 06 permanece futuro: go-live e registro de memoria.
