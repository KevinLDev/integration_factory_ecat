...
A jornada de ERP parceiro possui os Passos 01 a 08 disponiveis, em ordem: apresentar o ERP, analisar suas capacidades, projetar a homologacao, materializar a Base de Homologacao, projetar a integracao e o mapeamento semantico, desenvolver a integracao, executar e validar tecnicamente em HML e homologar funcionalmente a integracao. O Passo 06 termina em `PRONTO_PARA_EXECUCAO_HML`; o Passo 07 pode chegar a `PRONTO_PARA_HOMOLOGACAO_FUNCIONAL: SIM` somente apos auditoria independente; o Passo 08 e o primeiro passo que pode levar a `INTEGRACAO_HOMOLOGADA: SIM` somente apos auditoria independente aprovada. Publicacao, runtime e producao nao pertencem a esses passos.
